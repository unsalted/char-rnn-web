define('app',['exports', 'aurelia-framework', 'keras', 'weblas', 'lodash/flatten', 'async/times', 'async/each', 'async/queue', 'data/indices_char', 'data/char_indices', 'resources/sampling'], function (exports, _aureliaFramework, _keras, _weblas, _flatten, _times, _each, _queue, _indices_char, _char_indices, _sampling) {
  'use strict';
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_weblas2.default), _dec(_class = function () {
    ...
    App.prototype.uniq = function uniq(a) {
    ...
    App.prototype._predict = function _predict(data, temp, count) {
      ...
      var t0 = performance.now();
      var p = new Promise(function (resolve, reject) {
        _this.model.predict({ input: data }).then(function (res) {
    ...
    App.prototype.getWords = function getWords() {
      ...
      this._textPredict(text, 1, 5).then(function (chars) {
        ...
        chars = _this3.uniq(chars);
        var texts = chars.map(function (char) {
          return { char: char, text: char.replace(/^/, text), temp: 0.2 };
        });
...
define('resources/sampling',["exports"], function (exports) {
  ...
  exports.default = function () {
    ...
    function Binomial(n, p) {
      ...
      result.draw = function () {
        return bern.sample(n).reduce(_sum, 0);
      };
    ...
    function Discrete(probs) {
      ...
      result.draw = function () {
        var i, p;
        for (i = 0; i < k; i++) {
          p = probs[i] / probs.slice(i).reduce(_sum, 0);
...
define('lodash/chunk',['require','exports','module','./_baseSlice','./_isIterateeCall','./toInteger'],function (require, exports, module) {var baseSlice = require('./_baseSlice'),
...
define('lodash/_isIterateeCall',['require','exports','module','./eq','./isArrayLike','./_isIndex','./isObject'],function (require, exports, module) {var eq = require('./eq'),
...
define('lodash/eq',['require','exports','module'],function (require, exports, module) {/**
 * Performs a
 * [`SameValueZero`](http://ecma-international.org/ecma-262/7.0/#sec-samevaluezero)
 * comparison between two values to determine if they are equivalent.
 *
